...
Purpose:
- Perform Monte Carlo simulations to validate portfolio performance under random conditions.
...
def monte_carlo_simulation(returns, covariance_matrix, num_simulations=10000):
